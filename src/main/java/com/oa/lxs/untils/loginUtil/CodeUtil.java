package com.oa.lxs.untils.loginUtil;
...
public class CodeUtil {
    ...
    public static Map<String,Object> generateCodeAndPic(int width,int height,int fontHeight){
        ...
        //randomCode用于保存随机产生的验证码，以便用户登录后进行验证码
        ...
        for (int i = 0; i <codeCount ; i++) {
            ...
            //产生随机的颜色分量来构造颜色值，输出的每位数字的颜色值将不同
    ...
    public static void main(String[] args) throws Exception{
        ...
        Map<String,Object> map = CodeUtil.generateCodeAndPic(90,20,18);
